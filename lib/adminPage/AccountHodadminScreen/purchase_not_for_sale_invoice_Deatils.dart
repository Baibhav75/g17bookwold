...
import '/service/purchase_not_for_sale_invoice_service.dart';
import '/pdf/purchase_not_for_sale_invoice_pdf.dart';

class PurchaseNotForSaleInvoiceScreen extends StatefulWidget {
  final String billNo;

  const PurchaseNotForSaleInvoiceScreen({super.key, required this.billNo});

  @override
  State<PurchaseNotForSaleInvoiceScreen> createState() =>
      _PurchaseNotForSaleInvoiceScreenState();
}

class _PurchaseNotForSaleInvoiceScreenState
    extends State<PurchaseNotForSaleInvoiceScreen> {
  late Future<PurchaseNotForSaleInvoiceModel> future;

  @override
  void initState() {
    super.initState();
    future =
        PurchaseNotForSaleInvoiceService.fetchInvoice(widget.billNo);
  }

  Future<void> shareInvoice(PurchaseNotForSaleInvoiceModel data) async {
    final file = await PurchaseNotForSaleInvoicePdf.generate(data);
  ...
  Widget invoiceHeader(PurchaseNotForSaleInvoiceModel data) {
    return Column(
      children: [
        Row(
        ...
        const Text("Purchase Not For Sale Invoice",
        ...
        Table(
          ...
          children: [
            ...
            TableRow(children: [
              ...
              infoCell("Address: ", "T-6 1401 ACE PARKWAY SECTOR 150 NOIDA"),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<PurchaseNotForSaleInvoiceModel>(
        future: future,
                            ...
                            rows.add(
                              TableRow(
                                ...
                                children: [
                                  ...
                                  tableCell("0", weight: FontWeight.bold),
                                  const SizedBox(),
                                  const SizedBox(),
                                  tableCell("₹ ${subAmount.toStringAsFixed(2)}", weight: FontWeight.bold),
                                ],
                              ),
                            );
