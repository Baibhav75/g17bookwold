...
class ViewCompanyDiscountPdf {
  ...
  static pw.Widget _buildInvoiceTitle() {
    return pw.Center(
      child: pw.Column(
        children: [
          pw.Text(
            "Purchase Discount Apply Invoice",
            style: pw.TextStyle(
              fontSize: 16,
  ...
  static pw.Widget _buildInfoTable(ViewCompanyDiscountModel data, String formattedDate) {
    return pw.Table(
  ...
  static pw.Widget _buildItemsTable(ViewCompanyDiscountModel data) {
    Map<String, List<ViewCompanyItem>> grouped = {};
  ...
  static pw.Widget _buildFooter(ViewCompanyDiscountModel data) {
    double totalQty = 0;
    double totalAmount = 0;
    double totalDiscountAmount = 0;
    double totalAmtWithDisc = 0;
