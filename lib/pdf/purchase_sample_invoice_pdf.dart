...
class PurchaseSampleInvoicePdf {
  static Future<File> generate(PurchaseSampleInvoiceModel data) async {
    ...
    final file = File("${dir.path}/sample_invoice_${data.billNo}.pdf");
  ...
  static pw.Widget _buildInfoTable(PurchaseSampleInvoiceModel data, String formattedDate) {
    return pw.Table(
      ...
      children: [
        ...
        pw.TableRow(
          children: [
            ...
            _infoCell("Address: ", "1ST FLOOR VISHAL MARKET COMMERCIAL COMPLEX,WEST MUKHARJINAGAR"),
  ...
  static pw.Widget _buildItemsTable(PurchaseSampleInvoiceModel data) {
    Map<String, List<PurchaseSampleItem>> grouped = {};
    ...
    grouped.forEach((series, items) {
      ...
      rows.add(
        pw.TableRow(
          ...
          children: [
            pw.SizedBox(),
            _cell("Dis (0.00)% :", align: pw.TextAlign.right, isBold: true),
            pw.SizedBox(),
            pw.SizedBox(),
            _cell("Rs 0.0000", align: pw.TextAlign.center, isBold: true), 
            _cell("Rs ${subAmount.toStringAsFixed(4)}", align: pw.TextAlign.center, isBold: true),
          ],
        ),
      );
    });
    ...
    rows.add(
      pw.TableRow(
        ...
        children: [
          ...
          pw.SizedBox(),
          _cell("Rs 0.0000", align: pw.TextAlign.center, isBold: true),
          _cell("Rs ${totalAmount.toStringAsFixed(4)}", align: pw.TextAlign.center, isBold: true),
        ],
      ),
    );
